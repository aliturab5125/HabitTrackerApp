...
type RouteType = RouteProp<RootStackParamList, 'EditHabit'>;
...
export default function EditHabitScreen() {
  ...
  const [selectedColor, setSelectedColor] = useState<string>(habit?.color ?? colors.habitColors[0]);
  ...
  const [activeDays, setActiveDays] = useState<number[]>(habit?.activeDays ?? [0, 1, 2, 3, 4, 5, 6]);
  const [reminderTimes, setReminderTimes] = useState<string[]>(habit?.reminderTimes ?? []);
  ...
  const handleSave = useCallback(() => {
    ...
    close();
  }, [name, selectedEmoji, selectedColor, habitType, targetCount, activeDays, reminderTimes, editHabit, habitId, close, saveScale]);
            ...
            >
              ...
              <View style={styles.typeRow}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={[styles.typeBtnText, habitType === 'boolean' && styles.typeBtnTextActive]}>✓  Daily check</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={[styles.typeBtnText, habitType === 'count' && styles.typeBtnTextActive]}>#  Count target</Text>
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  handle: { width: 36, height: 4, backgroundColor: colors.inputBorder, borderRadius: radii.circle, alignSelf: 'center', marginBottom: spacing.sm },
  ...
  inputMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: spacing.xs, marginBottom: spacing.xs, minHeight: 16 },
  ...
  sectionLabel: { fontSize: fontSize.xxs, fontFamily: fontFamily.semiBold, fontWeight: '600', color: colors.textMuted, letterSpacing: letterSpacing.wide, textTransform: 'uppercase', marginTop: spacing.sm, marginBottom: spacing.sm },
  typeRow: { flexDirection: 'row', gap: spacing.sm },
  typeBtn: { flex: 1, paddingVertical: 10, borderRadius: radii.input, backgroundColor: colors.inputSurface, borderWidth: 1, borderColor: colors.inputBorder, alignItems: 'center' },
  ...
  targetRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.inputSurface, borderWidth: 1, borderColor: colors.inputBorder, borderRadius: radii.input, paddingHorizontal: 14, paddingVertical: 10 },
  targetLabel: { fontSize: fontSize.sm, fontFamily: fontFamily.regular, color: colors.textPrimary },
  targetInput: { fontSize: fontSize.md, fontFamily: fontFamily.bold, fontWeight: '700', color: colors.primary, textAlign: 'right', minWidth: 48 },
  emojiGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  emojiTile: { width: 40, height: 40, borderRadius: radii.emojiTile, backgroundColor: colors.emojiTileBg, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: 'transparent' },
  ...
  swatchWrapper: { width: 24, height: 24, borderRadius: radii.circle, borderWidth: 2, borderColor: 'transparent', alignItems: 'center', justifyContent: 'center' },
  swatchWrapperSelected: { borderColor: '#ffffff' },
  swatch: { width: 20, height: 20, borderRadius: radii.circle },
  daysRow: { flexDirection: 'row', gap: 6 },
  dayPill: { flex: 1, paddingVertical: 8, borderRadius: radii.pill, borderWidth: 1, borderColor: colors.inputBorder, alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent' },
  ...
  reminderPill: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.inputSurface, borderWidth: 1, borderColor: colors.inputBorder, borderRadius: radii.pill, paddingHorizontal: 14, paddingVertical: 8 },
  ...
  addReminderRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingVertical: 10 },
  ...
  saveButton: { height: 48, borderRadius: radii.pillLg, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', marginTop: spacing.md },
  ...
  iosPickerSheet: { backgroundColor: colors.modalSurface, borderTopLeftRadius: radii.sheet, borderTopRightRadius: radii.sheet, paddingBottom: spacing.xl },
  iosPickerHeader: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderBottomWidth: 1, borderBottomColor: colors.inputBorder },
