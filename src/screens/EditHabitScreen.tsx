...
function EmojiTile({ emoji, isSelected, onPress }: EmojiTileProps) {
  ...
  useEffect(() => {
    scale.value = withSpring(isSelected ? 1.1 : 1, { damping: 12, stiffness: 220 });
  }, [isSelected, scale]);
...
export default function EditHabitScreen() {
  ...
  const handleSave = useCallback(() => {
    ...
    editHabit(habitId, name.trim(), selectedEmoji, selectedColor);
    close();
  }, [name, selectedEmoji, selectedColor, editHabit, habitId, close, saveScale]);
